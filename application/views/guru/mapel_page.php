		...
		<div class="modal fade" id="addMapel" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="<?php echo base_url('index.php/guru/mapel/mapel_add')?>" method="POST" class="form" >
						...
						<td align="center">
							<button class="btn btn-danger btn-border dropdown-toggle btn-sm" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Aksi &nbsp;</button>
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="<?php echo base_url('index.php/guru/mapel/kompetensi?mapel_id='.$value['mapel_id'].'')?>" title="<?php echo $title; ?>">Lihat KD</a>

									<?php if(empty($value['ujian_id'])) { ?>
									<a class="dropdown-item" href="<?php echo base_url('index.php/guru/mapel/mapel_del') ?>?mapel_id=<?php echo $value['mapel_id'] ?>" title="<?php echo $title; ?>" onclick="return confirm('KONFIRMASI : Hapus data..?');">Hapus</a>
								<?php } ?>
								</div>
						</td>
					</tr>
		...
		<div class="modal fade" id="editMapel<?php echo $value['mapel_id'];?>" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="<?php echo base_url('index.php/guru/mapel/mapel_update')?>" method="POST" class="form" >
					<div class="modal-body">
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group form-group-default">
...
<script type='text/javascript'>
  setTimeout(function () {  
	swal("Selamat!", "Data mata pelajaran berhasil disimpan!", {
			icon : "success",
			buttons: {        			
			confirm: {
...
<script type='text/javascript'>
  setTimeout(function () {  
	swal("Selamat!", "Data mata pelajaran berhasil diperbaharui!", {
			icon : "success",
			buttons: {        			
			confirm: {
			className : 'btn btn-black'
