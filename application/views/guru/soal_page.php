<div class="row">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<form action="<?php echo base_url('index.php/guru/ujian/soal_add') ?>" method="POST">
				...
				<div class="form-group">
					...
					<input type="submit" name="submit" value="Simpan" class="btn btn-primary" >
					 &nbsp;&nbsp;&nbsp;
					<a href="<?php echo base_url('index.php/guru/ujian/ujian')?>" class="btn btn-danger"><i class="fas fa-door-open"></i> Selesai</a>
				</div>
			</form>
			</div>
		</div>
