	...
	<div class="wrapper wrapper-login">
		<div class="container container-login animated fadeIn">
			...
			<div class="login-form">
				<form action="<?php echo base_url('index.php/guru/login/password_update') ?>" method="POST" id="exampleValidation">
				...
				<div class="form-group form-action-d-flex mb-3">
					<input type="hidden" name="guru_id" value="<?php echo $this->input->get('guru_id'); ?>">
