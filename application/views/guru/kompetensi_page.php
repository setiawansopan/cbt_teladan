...
<div class="card">
	...
	<div class="card-header">
		<div class="d-flex align-items-center">			
			<h4 class="card-title"><?php echo $n_mapel->mapel_nama; ?></h4> 
	...
	<div class="card-body">
		...
		<div class="modal fade" id="addKompetensi" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="<?php echo base_url('index.php/guru/mapel/kompetensi_add')?>" method="POST" class="form" >
		...
		<div class="table-responsive">
			<form action="<?php echo base_url('index.php/guru/mapel/kompetensi')?>" method="POST" enctype="multipart/form-data">
						...
						<td align="center">
							<button class="btn btn-danger btn-border dropdown-toggle btn-sm" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Aksi &nbsp;</button>
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="<?php echo base_url('index.php/guru/mapel/kompetensi_del?kd_id='.$value['kd_id'].'&kd_mapel_id='.$value['kd_mapel_id']).''?>" onclick="return confirm('KONFIRMASI : Hapus data..?');">Hapus</a>
							    </div>
						</td>
					</tr>
					...
					<div class="modal fade" id="edit<?php echo $value['kd_id'];?>" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<form action="<?php echo base_url('index.php/guru/mapel/kompetensi_update')?>" method="POST" class="form" >
								<div class="modal-body">
