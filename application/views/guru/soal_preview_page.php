			...
			<div class="card-body">			
				...
				<div class="form-group">
					<div class="row">
						...
						<a href="<?php echo base_url('index.php/guru/ujian/soal_preview')?>?ujian_id=<?php echo $ujian->ujian_id;?>&soal_id=<?php echo $mm->first; ?>&n=1" class="btn btn-warning"><i class="fas fa-angle-double-left"></i> First </a>
						<a href="<?php echo base_url('index.php/guru/ujian/soal_preview')?>?ujian_id=<?php echo $ujian->ujian_id;?>&soal_id=<?php echo $prev->soal_id; ?>&n=<?php echo $nomor-1; ?>" class="btn btn-warning" > <i class="fas fa-angle-left"></i> Prev </a>
						<?php } ?>
						<?php if(!empty($next->soal_id)) { ?>
						<a href="<?php echo base_url('index.php/guru/ujian/soal_preview')?>?ujian_id=<?php echo $ujian->ujian_id;?>&soal_id=<?php echo $next->soal_id; ?>&n=<?php echo $nomor+1; ?>" class="btn btn-primary"> Next <i class="fas fa-angle-right"></i> </a>
						<a href="<?php echo base_url('index.php/guru/ujian/soal_preview')?>?ujian_id=<?php echo $ujian->ujian_id;?>&soal_id=<?php echo $mm->last; ?>&n=<?php echo $mm->max; ?>" class="btn btn-primary"> Last <i class="fas fa-angle-double-right"></i> </a>
						<?php } ?>
						</div>
						<div class="col-md-6" align="right">
						<a href="<?php echo base_url('index.php/guru/ujian/soal_edit')?>?ujian_id=<?php echo $ujian->ujian_id;?>&soal_id=<?php echo $soal->soal_id; ?>&n=<?php echo $nomor; ?>" class="btn btn-secondary"><i class="fas fa-user-edit"></i> Edit</a>
						<a href="<?php echo base_url('index.php/guru/ujian/soal_hapus')?>?ujian_id=<?php echo $ujian->ujian_id;?>&soal_id=<?php if(!empty($prev->soal_id)) echo $prev->soal_id; ?>&n=<?php echo $nomor-1; ?>&hapus_id=<?php echo $soal->soal_id; ?>" class="btn btn-danger" onclick="return confirm('KONFIRMASI : Hapus data..?');"><i class="fas fa-trash-alt"></i> Hapus</a>
						<a href="#" class="btn btn-black" data-toggle="modal" data-target="#pindahSoal"><i class="fas fa-random"></i> Pindah</a>
						<a href="<?php echo base_url('index.php/guru/ujian/ujian')?>" class="btn btn-success" ><i class="fas fa-door-open"></i> Selesai</a>
						</div>
					</div>
			</form>
			</div>
...
<div class="modal fade" id="pindahSoal" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="<?php echo base_url('index.php/guru/ujian/pindah_soal')?>" method="POST" class="form" >
