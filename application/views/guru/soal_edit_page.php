<div class="row">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<form action="<?php echo base_url('index.php/guru/ujian/soal_update') ?>?ujian_id=<?php echo $ujian->ujian_id;?>&soal_id=<?php echo $soal->soal_id; ?>&n=<?php echo $nomor; ?>" method="POST">
				...
				<div class="form-group">
					...
					<input type="submit" name="submit" value="Update" class="btn btn-primary" >
					 &nbsp;&nbsp;&nbsp;
					<a href="<?php echo base_url('index.php/guru/ujian/soal_preview')?>?ujian_id=<?php echo $ujian->ujian_id;?>&soal_id=<?php echo $soal->soal_id; ?>&n=<?php echo $nomor; ?>" class="btn btn-danger"><i class="fas fa-reply-all"></i>&nbsp;Batal</a>
				</div>
			</form>
			</div>
		</div>
