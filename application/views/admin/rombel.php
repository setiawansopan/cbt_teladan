			...
			<table id="add-row" class="display table table-sm table-striped table-hover table-head-bg-*states" >
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><a href="<?php echo base_url('index.php/admin/rombel_con/rombel_anggota')?>?rombel=<?php echo $value['peserta_kelas'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-user-friends"></i> Lihat Anggota</a></td>
					</tr>
					<?php $no++; } ?>
				</tbody>
			</table>
