...
<body style="background-color: #404242;" oncontextmenu="return false;">
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<form id="formJawaban" action="<?php echo base_url('index.php/exam/soal/act')?>" method="POST" onsubmit="return alertSelesai();">
