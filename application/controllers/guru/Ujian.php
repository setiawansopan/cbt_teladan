...
class Ujian extends CI_Controller {
	...
	public function ujian_add()
	{
		...
		//$this->load->model('guru/main_mod');
		$this->main_mod->insert('cbt_ujian', $data);
		$this->session->set_flashdata('simpan','true');
		redirect(base_url('index.php/guru/ujian/ujian'));
	}
	...
	public function soal_add()
	{
		...
		redirect(base_url('index.php/guru/ujian/soal?ujian_id='.$this->input->post('soal_ujian_id')));
	}
	...
	public function soal_hapus()
	{
		...
		redirect(base_url('index.php/guru/ujian/soal_preview').'?ujian_id='.$this->input->get('ujian_id').'&soal_id='.$this->input->get('soal_id').'&n='.$this->input->get('n'));
		} else {
		...
		redirect(base_url('/index.php/guru/ujian/soal_preview?ujian_id='.$this->input->get('ujian_id').'&soal_id='.$soal_id.'&n='.$new_n));
		} 
		else {
		redirect(base_url('index.php/guru/ujian/ujian'));
		}
	...
	public function soal_update()
	{
		...
		redirect(base_url('index.php/guru/ujian/soal_preview').'?ujian_id='.$ujian_id.'&soal_id='.$soal_id.'&n='.$nomor);
	}
